        ...
        <div class="main_container">
            ...
            <div class="right_col" role="main">
                ...
                <fieldset class="scheduler-border">
                    <legend class="scheduler-border"> Por favor, preencha os dados referentes ao aluno </legend>
                    <form method="POST" action="form_aluno.php">
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                Nome:
                                <br>
                                <input type="text" name="nome" id="nome" class="campo"> <br>
                            </div>
                            <div class="form-group col-md-6">
                                Email:
                                <br>
                            ...
                            <div class="form-group col-md-6">
                                Número de Matricula:
                                <br>
                                <input type="text" name="num_matricula" id="num_matricula" class="campo">
                                <br>
                            </div>
                            ...
                            <div class="form-group col-md-6">
                                Ano Letivo:
                                <br>
                                <input type="text" name="ano_letivo" id="ano_letivo" class="campo">
                                <br>
                            </div>
                            <br>
                            <div class="form-group col-md-6 ">
