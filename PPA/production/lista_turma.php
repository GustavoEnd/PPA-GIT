    ...
    <div class="main_container">
      ...
      <div class="text-center">
        ...
        <fieldset class="scheduler-border">
            <legend class="scheduler-border">Turmas Cadastradas</legend>
        <table class="table">
          ...
          foreach ($result as $linha) {
            ...
            echo '<td>' . $linha["descricaoTurma"] . '</td>';
            echo '<td>' . $linha["anoReferencia"] . '</td>';
            echo '<td>' . $linha["turno"] . '</td>';
            echo '<td>' . $linha["serie"] . '</td>';

            $id_turma = $linha["id_turma"];
            echo '<td><a class="btnExcluir" href="excluir_proj.php?id_turma=' . $id_turma . '">Excluir</a></td>';
            echo '<td><a class="btnEditar" href="editar_projetos.php?id_turma=' . $id_turma . '">Editar</a></td>';
            echo '</tr>';
          }
          echo '</table>';
          ?>
